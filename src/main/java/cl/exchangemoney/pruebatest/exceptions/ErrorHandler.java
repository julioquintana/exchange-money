...
import cl.exchangemoney.pruebatest.dto.ErrorDto;
import cl.exchangemoney.pruebatest.util.Constant;
import cl.exchangemoney.pruebatest.util.LogFormatter;
...
public class ErrorHandler {
  ...
  @ExceptionHandler(ExchangeMoneyException.class)
  public ResponseEntity<ErrorDto> appException(ExchangeMoneyException e) {
    Map<String, String> messages = new LinkedHashMap<>();
